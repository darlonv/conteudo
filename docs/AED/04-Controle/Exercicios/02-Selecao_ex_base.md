...
:::::{exercise}
:label: ex:selecao_existem_raizes_segundo_grau_eq
Informe se uma equação de segundo grau possui 
ou não raízes reais, utilizando o $\Delta$ da fórmula de Bháskara.
